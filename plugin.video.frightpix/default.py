...
def CATEGORIES():
    ...
    main.addDir('[COLOR white]Monster[/COLOR]','http://www.frightpix.com/Monster-movies','indexdeep',artPath+'monster.png','','movies')
    main.addDir('[COLOR white]Zombie[/COLOR]','http://www.frightpix.com/Zombie-movies','indexdeep',artPath+'zombie.png','','movies')
    main.addDir('[COLOR white]Sex,Drugs & Rock and Roll[/COLOR]','http://www.frightpix.com/Sex,-Drugs,-and-Rock-n-Roll-movies','indexdeep',artPath+'rnr.png','','movies')
    ...
    main.addDir('[COLOR white]The Tomb[/COLOR]','http://www.frightpix.com/The-Tomb-movies','indexdeep',artPath+'tomb.png','','movies')
    main.addDir('[COLOR white]TV Series[/COLOR]','http://www.frightpix.com/TV-Series','indexdeep',artPath+'tvseries.png','','tv')
